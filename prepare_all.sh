...
# ./prepsonatas.sh scarlatti-sonatas ../datasets/src/sonatas/scarlatti-keyboard-sonatas ../datasets/prep/sonatas/scarlatti-keyboard-sonatas --label-encoder multi2_ext --remove-splits
...
# ./prepsonatas.sh scarlatti-sonatas ../datasets/src/sonatas/scarlatti-keyboard-sonatas ../datasets/prep/sonatas/scarlatti-keyboard-sonatas --label-encoder multi2 --remove-splits
# ./prepsonatas.sh scarlatti-sonatas ../datasets/src/sonatas/scarlatti-keyboard-sonatas ../datasets/prep/sonatas/scarlatti-keyboard-sonatas --label-encoder multi2